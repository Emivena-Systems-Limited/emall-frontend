import { CheckCircle2, Pause, TicketPercent } from 'lucide-react'
import { COUPON_STATUS_STATS } from '../../constants/coupons'
...
export default function CouponStatsGrid({ summary, activeKey, onSelect }) {
  const values = {
    all: summary.total,
    live: summary.live,
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      {COUPON_STATUS_STATS.map((stat) => {
        const Icon = ICONS[stat.icon] ?? TicketPercent
