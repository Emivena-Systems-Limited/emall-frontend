...
export const progressLog = [
  ...
  },
  {
    ...
    items: [
      ...
      'Wired address endpoints GET /user/get-addresses and POST /user/create-address with checkout selection and support for saving multiple delivery addresses; default addresses are selected when the API returns is_default. Live authenticated tests now confirm GET /user/get-addresses and GET /checkout/preview return 200. Saved-address creation uses the backend schema: type, first_name, last_name, phone_number, region, city_or_town, address_line_1, and country.',
      ...
      'Corrected saved-address response normalization for GET /user/get-addresses: delivery addresses are returned in data.shipping and now persist visibly after checkout-page refreshes.',
