...
function CartItemRowSkeleton() {
  return (
    <div className={LINE_ITEM_TABLE_ROW_CLASS}>
      <div className={`flex min-w-0 items-start gap-3 sm:items-center ${LINE_ITEM_TABLE_CELL_PADDING}`}>
        ...
        <Pulse className="size-16 shrink-0 rounded-lg sm:size-20" />
...
export default function CartPageSkeleton({ rows = 3 }) {
  return (
    <div className="min-w-0 space-y-6 sm:space-y-8" aria-busy="true" aria-label="Loading shopping cart">
      <div className="min-w-0 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] lg:gap-x-8">
        <div className="mb-4 min-w-0 lg:col-start-1 lg:row-start-1">
        ...
        <div className="min-w-0 lg:col-start-2 lg:row-start-2 lg:self-start">
          <div className="mt-6 rounded-xl border border-slate-200 bg-white p-4 sm:p-5 lg:sticky lg:top-20 lg:mt-0">
