...
// Validation → productListingSchema / productInfoSchema`}
            ...
            >
              <ul className="space-y-2 text-sm leading-relaxed text-slate-700">
                ...
                <li>• <strong>View product</strong> — <code className="rounded bg-slate-100 px-1 text-xs">/products/:id/view</code> reconstructs Color → secondary pickers from flat <code className="rounded bg-slate-100 px-1 text-xs">attributes</code>, resolves one leaf SKU, and shows that variant’s price, stock, photos (up to 3), and id. Color uses image tiles; other attributes use chips unless every value has a photo.</li>
