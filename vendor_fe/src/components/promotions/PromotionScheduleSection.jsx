...
export default function PromotionScheduleSection({ form, readOnly, onChange, error }) {
  if (!form.type) {
    return (
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_16px_45px_rgba(15,23,42,0.04)]">
        ...
        <p className="mt-2 text-sm text-slate-500">Select a promotion type above to configure the schedule.</p>
