...
export default function ReviewsDevToggle({ enabled, onChange, reviewCount }) {
  ...
  return (
    <label className="inline-flex cursor-pointer items-center gap-2.5 rounded-xl border border-dashed border-amber-400 bg-amber-50 px-3 py-2 ring-1 ring-amber-200/60">
      ...
      <span className="text-xs font-semibold text-amber-900">Dummy data</span>
      <button
        type="button"
        role="switch"
        aria-checked={enabled}
        aria-label="Toggle dummy review data"
